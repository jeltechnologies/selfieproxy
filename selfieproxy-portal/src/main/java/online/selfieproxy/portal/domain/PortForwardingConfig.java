 ...
 * @param description optional free-text note (eg. "Minecraft server") for the admin's own benefit --
 *                     never validated/used by anything else, blank/null means none was given; included
 *                     in configuration export/import like every other field here
 */
public record PortForwardingConfig(
		String fqdn, PortForwardingProtocol protocol, int publicPort, int targetPort, String description) {
}
