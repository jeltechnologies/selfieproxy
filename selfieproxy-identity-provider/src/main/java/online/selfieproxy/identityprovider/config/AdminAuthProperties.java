 ...
 * are whatever's stored there (rotated via AccountController's self-service
 * page, or the forced first-login password change), not these values -- see
 * AdminUserStore, LoginController and AccountController.
 */
